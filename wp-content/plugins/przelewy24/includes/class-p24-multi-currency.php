...
class P24_Multi_Currency implements P24_MC_Interface {
	...
	/**
	 * Support for MC on admin orders.
	 *
	 * @var P24_MC_Admin_Order
	 */
	private $mc_admin_order;
	...
	public function __construct( P24_Core $plugin_core, $active_currency ) {
		...
		if ( is_admin() ) {
			$this->mc_admin_order = new P24_MC_Admin_Order( $this, $this->plugin_core );
		}
	 ...
	 *
	 * @param string|null $suggested Suggested product class.
	 * @return string
	 */
	...
	public function bind_events() {
		...
		if ( is_admin() ) {
			$this->mc_admin_order->bind_common_events();
		} else {
