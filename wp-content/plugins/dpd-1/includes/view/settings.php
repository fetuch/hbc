            ...
            <div class="d-content js-d-content">
                <div class="d-contentbox">
                    <div class="d-settings">
                        ...
                        <hr>
                        <div class="d-field">
                            <label for="d-setting-include-shipping-price"><?php _e('Include shipping price', 'dpdro'); ?>:</label>
                            <div class="d-field-list">
                                <ul>
                                    <?php if ($dataSettings['include_shipping_price'] == '1') : ?>
                                        <li>
                                            <input class="js-d-setting" id="d-setting-include-shipping-price-yes" type="radio" name="include_shipping_price" value="1" checked />
                                            <label for="d-setting-include-shipping-price-yes"><?php _e('Yes', 'dpdro'); ?></label>
                                        </li>
                                        <li>
                                            <input class="js-d-setting" id="d-setting-include-shipping-price-no" type="radio" name="include_shipping_price" value="0" />
                                            <label for="d-setting-include-shipping-price-no"><?php _e('No', 'dpdro'); ?></label>
                                        </li>
                                    <?php else : ?>
                                        <li>
                                            <input class="js-d-setting" id="d-setting-include-shipping-price-yes" type="radio" name="include_shipping_price" value="1" />
                                            <label for="d-setting-include-shipping-price-yes"><?php _e('Yes', 'dpdro'); ?></label>
                                        </li>
                                        <li>
                                            <input class="js-d-setting" id="d-setting-include-shipping-price-no" type="radio" name="include_shipping_price" value="0" checked />
                                            <label for="d-setting-include-shipping-price-no"><?php _e('No', 'dpdro'); ?></label>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                                <small><?php _e('Select <b>"Yes"</b> if you want to add the transport value to the COD amount.', 'dpdro'); ?></small>
                            </div>
                        </div>
                        <hr>
                        <div class="d-field">
