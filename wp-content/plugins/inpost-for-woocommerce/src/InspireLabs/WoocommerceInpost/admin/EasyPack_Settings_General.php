	...
	class EasyPack_Settings_General extends WC_Settings_Page {
		...
		public function get_settings() {
			...
			$settings = [
                ...
                [
                    'title'    => __( 'Send a letter to the buyer about the start of the delivery process just after parcel created?',
                        'woocommerce-inpost' ),
                ...
                [
                    'title'    => __( 'Enable JS-mode of map button (for example if use Multisite Wordpress and have problem with output of map button)',
                        'woocommerce-inpost' ),
                                    ...
                                    <tr id="<?php echo esc_attr( EasyPack::ATTRIBUTE_PREFIX ); ?>_dpoint_<?php echo esc_attr( $k ); ?>"
                                        ...
                                        <td>
                                            <input
                                                    class="<?php echo esc_attr(EasyPack::ATTRIBUTE_PREFIX ); ?>_dpoint"
                                                    value=""
                                                    name="<?php echo esc_attr(EasyPack::ATTRIBUTE_PREFIX ); ?>_dpoint_city[]"
                                                    id="<?php echo esc_attr( EasyPack::ATTRIBUTE_PREFIX ); ?>_dpoint_city">
                                        </td>
                                    </tr>
									<?php
